...
class StackApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.insert_button = tk.Button(button_frame, text="Insert", font=button_font, bg=button_bg, fg=button_fg, command=self.insert_item, width=12, height=2)
        self.insert_button.pack(side=tk.LEFT, padx=10)

        self.delete_button = tk.Button(button_frame, text="Delete", font=button_font, bg=button_bg, fg=button_fg, command=self.delete_item, width=12, height=2)
        ...
        self.traverse_button = tk.Button(button_frame, text="Traverse", font=button_font, bg=button_bg, fg=button_fg, command=self.traverse_stack, width=12, height=2)
    ...
    def insert_item(self):
        item = simpledialog.askstring("Input", "Enter an item to insert:", parent=self)
        if item:
            position = simpledialog.askinteger("Input", "Enter the position to insert the item:", parent=self)
    ...
    def delete_item(self):
        position = simpledialog.askinteger("Input", "Enter the position to delete the item from:", parent=self)
        if position is not None:
            try:
